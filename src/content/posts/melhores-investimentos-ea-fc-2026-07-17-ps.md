---
author: "FutQuant"
pubDatetime: 2026-07-18T01:58:09.000Z
...
faq:
  - q: "Qual a melhor carta para investir hoje (17/07/2026) no EA FC?"
    a: "Granit Xhaka (91, sem liga) lidera, com +86% em 7 dias a 42k coins no Console (PS). A lista mede momentum e deve ser confirmada com uma cotação atual antes da compra."
...
> 🔝 **Destaque:** Granit Xhaka (91) acumula **+86% em 7 dias** a 42k coins; leitura atual: **esticada**.
...
- A mediana é de **+5.4% em 24h** e **+73.9% em 7 dias**.
...
| --- | --- | --- | --- | --- | --- | --- |
| Granit Xhaka | 91 | — | 42k coins | +3.2% | +86% | Esticada |
| Nahuel Molina | 91 | — | 130k coins | +1.6% | +85.7% | Esticada |
| Josip Šutalo | 90 | Eredivisie | 74k coins | +7.3% | +84.9% | Esticada |
| Keinan Davis | 90 | — | 45k coins | +1.7% | +83.7% | Esticada |
| Pavel Šulc | 91 | — | 45k coins | +12.8% | +79.6% | Esticada |
| Federico Bernardeschi | 91 | — | 34k coins | +16.6% | +79.2% | Esticada |
| Ona Batlle | 90 | Liga F | 48k coins | +6.7% | +77.6% | Esticada |
| Alberto Costa | 91 | — | 30k coins | +3.4% | +73.9% | Esticada |
| Marta | 90 | NWSL | 74k coins | +1.4% | +72.9% | Esticada |
| Ivan Perišić | 90 | Eredivisie | 60k coins | +9.1% | +72.7% | Esticada |
| Troy Parrott | 91 | — | 59k coins | +5.4% | +71% | Esticada |
| Luís Figo | 90 | Icons | 34k coins | +10.2% | +70% | Esticada |
| Abedi Pelé | 91 | Ligue 1 McDonald's | 96k coins | +20% | +69.9% | Esticada |
| Jürgen Kohler | 91 | — | 50k coins | +1% | +68.1% | Esticada |
| Homare Sawa | 91 | Icons | 128k coins | +2.4% | +67.5% | Esticada |


## 📈 Análise dos destaques

- **Granit Xhaka (91)** — 42k coins, **+86% em 7 dias** (+3.2% em 24h). Preço +47% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Nahuel Molina (91)** — 130k coins, **+85.7% em 7 dias** (+1.6% em 24h). Preço +41% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Josip Šutalo (90)** — 74k coins, **+84.9% em 7 dias** (+7.3% em 24h). Preço +59% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Keinan Davis (90)** — 45k coins, **+83.7% em 7 dias** (+1.7% em 24h). Preço +44% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Pavel Šulc (91)** — 45k coins, **+79.6% em 7 dias** (+12.8% em 24h). Preço +48% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.
...
Granit Xhaka (91, sem liga) lidera, com +86% em 7 dias a 42k coins no Console (PS). A lista mede momentum e deve ser confirmada com uma cotação atual antes da compra.
...
- [Jogadores baratos EA FC: Cartas 90+ em 17/07 — Console (PS)](/posts/jogadores-baratos-ea-fc-2026-07-17-ps/)
- [Mercado EA FC em 17/07: Cartas 90+ — Console (PS)](/posts/mercado-ea-fc-2026-07-17-ps/)
