...
title: "Cartas 90+ baratos no EA FC em 11/07 — PS"
draft: false
featured: false
tags:
  - baratos
  ...
  - budget
  - ps
description: "Em 11/07/2026 no PS, Rudi Völler liderou a seleção de Cartas 90+ por 15.000 coins. Compare 7 cartas, OVR, preço, 7d e gráfico."
---
...
Entre 7 opções, **Rodri** tinha o menor preço (2.000 coins). O maior OVR era de **Rudi Völler** (94), por 15.000 coins.

O preço mediano do recorte foi **9.000 coins** e 5 cartas vinham de queda em 7d. 3 opções estavam exatamente no teto de 15.000 coins. OVR é só um filtro inicial; função, atributos, PlayStyles e química precisam ser conferidos antes de montar o time.

![Gráfico de preço em coins para os destaques de Cartas 90+ baratos no EA FC em 11/07 — PS](/charts/jogadores-baratos-ea-fc-2026-07-11-ps.svg)

*Gráfico gerado exclusivamente com os valores da tabela deste artigo.*
<!-- /historical-review:v1 -->

Dá para montar um time forte no **EA FC Ultimate Team** sem torrar coins. O **FutQuant** filtrou as **cartas 83+ que custam até 15 mil coins** em **11/07/2026** no **Console (PS)** — puro custo-benefício, sem anomalias de preço.
...
- **Rudi Völler (94, ST)**, sem liga informada, a apenas **15k coins**

- **Sergiño Dest (93, RW)**, sem liga informada, a apenas **15k coins** — já **valorizando**, o que indicava procura crescente naquele recorte.

- **Aitana Bonmatí (91, CM)** da Liga F, a apenas **9k coins** — vem **caindo na semana**, era uma opção relativamente barata naquele recorte.

- **Gianluca Vialli (91, ST)**, sem liga informada, a apenas **15k coins** — vem **caindo na semana**, era uma opção relativamente barata naquele recorte.
